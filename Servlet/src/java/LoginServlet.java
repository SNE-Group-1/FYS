    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            if(Reader.verify(name, ticketNumber)){
                ...
                String[] command = {"sudo iptables -P INPUT ACCEPT","sudo iptables -P FORWARD ACCEPT","sudo iptables -P OUTPUT ACCEPT","sudo iptables -t nat -F","sudo iptables -t mangle -F","sudo iptables -F","sudo iptables -X","sudo tee /etc/iptables/rules.v4"};  // Only change!
